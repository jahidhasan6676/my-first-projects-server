  ...
  try {
    ...
    app.post("/create-ssl-payment", async (req, res) => {
      ...
      const initiate = {
        ...
        currency: 'BDT',
        tran_id: trxId,
        success_url: 'https://my-first-projects-server.onrender.com/success-payment',
        fail_url: 'https://shopper-application-3cae2.web.app/fail',
        cancel_url: 'https://shopper-application-3cae2.web.app/cancel',
        ipn_url: 'https://my-first-projects-server.onrender.com/ipn-success-payment',
    ...
    app.post("/success-payment", async (req, res) => {
      ...
      res.redirect("https://shopper-application-3cae2.web.app/dashboard/paymentHistory")
